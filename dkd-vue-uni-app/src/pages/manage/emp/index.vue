<template>
  <view class="layout-container">
    <NavBar class="nav-bar-comp" back breadcrumb="Home" title="Employees" :showAdd="hasPermission('manage:emp:add')" @add="handleAdd" />
      ...
      <view class="modal-content" @click.stop>
        ...
        <view class="modal-body">
          ...
          <view class="form-item">
            ...
            <input class="n-input" v-model="form.mobile" type="number" placeholder="Enter mobile number" />
          </view>
          <view class="form-item">
