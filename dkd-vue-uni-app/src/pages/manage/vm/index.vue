<template>
  <view class="layout-container">
    <NavBar class="nav-bar-comp" back breadcrumb="Home" title="Devices" :showAdd="hasPermission('manage:vm:add')" @add="handleAdd" />
    <view class="search-bar">
      <input class="n-input search-input" v-model="queryParams.innerCode" placeholder="Search by Device Code" @confirm="handleSearch" />
      ...
      <picker mode="selector" :range="vmTypeList" range-key="name" :value="filterVmTypeIndex" @change="onFilterVmTypeChange">
        <view class="filter-picker">{{ queryParams.vmTypeId ? vmTypeList[filterVmTypeIndex]?.name : 'All VM Types' }}</view>
      </picker>
      <picker mode="selector" :range="vmStatusOptions" :value="filterVmStatusIndex" @change="onFilterVmStatusChange">
        <view class="filter-picker">{{ vmStatusOptions[filterVmStatusIndex] }}</view>
      </picker>
      <input class="n-input search-input" v-model="queryParams.policyId" placeholder="Search by Policy ID" @confirm="handleSearch" />
    </view>
